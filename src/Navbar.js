  ...
  const signOut = () => {
    ...
    return (
        ...
        <Avatar alt={user.displayName} src={user.photoURL} />
          <img alt="top img" className="topimg" src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.XXCiu9M79mUiIp-sTxspQwHaEc%26pid%3DApi&f=1"/>
